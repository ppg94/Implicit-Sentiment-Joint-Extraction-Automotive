...
EXPERIMENT_NAME = f'{LLM_MODEL_NAME}_no_CoT'  
LEADERBOARD_CSV_PATH = f'{LLM_MODEL_NAME}_product_issue_leaderboard.csv'
LLM_RAW_RESPONSES_DIR = f'./{LLM_MODEL_NAME}_noCoT_raw_llm_responses/'
LLM_RESPONSES_DIR = f'./{LLM_MODEL_NAME}_noCoT_llm_responses/'
COT_LOGS_DIR = f'./{LLM_MODEL_NAME}_nocot_thinking_logs/' 
